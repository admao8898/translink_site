...
namespace TranslinkSite.Locators
{
    public class NextBusPageLocators
    {
        ...
        public static readonly By NextBusField = By.Name("NextBusSearchTerm");
        public static readonly By FindNB_Button = By.XPath("//button[contains(text(),'Find my next bus')]");
        public static readonly By UseCurrentLocationButton = By.Name("useCurrentLocation");
        ...
        public static readonly By MapView = By.CssSelector("a.toggleTextMapView"); //Toggle for text view as well
