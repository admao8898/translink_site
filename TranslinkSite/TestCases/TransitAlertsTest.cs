...
namespace TranslinkSite.TestCases
{
    public class TransitAlertsTest : UITestFixture
    {
        ...
        {
            TransitAlertPage transitAlertPage = new(driver);
            ...
            // Verify page header
            StringAssert.Contains(driver.FindElement(By.TagName("h1")).Text,
                                  transitAlertPageLocators.TransitAlertsPageHeader,
            ...
            //                       transitAlertPageLocators.expectedNameFailMsg,
            //                       transitAlertPageLocators.nameFailMsgMissing);
            //
            // StringAssert.Contains(driver.FindElement(By.TagName("body")).Text,
            //                       transitAlertPageLocators.expecte
